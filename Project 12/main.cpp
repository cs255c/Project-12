/* Adds, updates, deletes, and prints records of id#, name, and age
 * Data file = nameage.dat, output text to print.txt
 * 5/1/2015
 * Alex Debrecht */
...
void updateRecord( fstream &updateFile )
{
	...
	updateFile.seekg((idNumber - 1 ) * sizeof(Person),ios::beg);
	...
	if(person.getId() != 0)
	{
		...
		// move file-position pointer to correct record in file
		updateFile.seekp((person.getId() - 1 ) * sizeof(Person));
...
void newRecord( fstream &insertInFile )
{
	...
	// move file-position pointer to correct record in file
	insertInFile.seekg((idNumber - 1 ) * sizeof(Person),ios::beg);
	...
	if ( person.getId() == 0 )
	{
		...
		person = Person(idNumber,lastName,firstName,age);
...
void deleteRecord( fstream &deleteFromFile )
{
	...
	// move file-position pointer to correct record in file
	deleteFromFile.seekg((idNumber - 1 ) * sizeof(Person),ios::beg);
